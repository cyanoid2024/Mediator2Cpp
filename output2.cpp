...
struct election_module{
	int id;
	Port<voteMsg> left(Direction dir1 = in);
Port<voteMsg> right(Direction dir1 = out);
Port<localMsg> query(Direction dir1 = in);
Port<localMsg> notice(Direction dir1 = out);
...
struct worker{
	int name;
	Port<localMsg> query(Direction dir1 = out);
Port<localMsg> notice(Direction dir1 = in);
